...
data <- data %>%
  ...
  select(-CustomerID) # Remove identifier column
...
# GLMNET Model: Lasso and Ridge Regression combined (alpha = 0.5)
...
# Random Forest Model with 500 Trees and mtry = 3
...
# Random Forest Accuracy, AUC, and Confusion Matrix
...
# XGBoost Accuracy, AUC, and Confusion Matrix
